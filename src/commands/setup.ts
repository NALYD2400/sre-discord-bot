      ...
      const structure: {
      ...
      }[] = [
        {
          ...
          channels: [
            ...
            { name: '🔄・mises-à-jour',    type: ChannelType.GuildText,  topic: 'Patchnotes & nouvelles versions de l\'application' },
            {
              name: '📜・règlement',
            ...
            { name: '🗺️・roadmap',         type: ChannelType.GuildText,  topic: 'Feuille de route et fonctionnalités prévues' },
          ],
        },
        {
          category: '💬 COMMUNAUTÉ',
          channels: [
            { name: '💬・général',          type: ChannelType.GuildText,  topic: 'Discussion générale autour de SR Editer' },
            { name: '🖼️・créations',        type: ChannelType.GuildText,  topic: 'Montre tes créations, textures et modding', slowmode: 5 },
            { name: '🔗・partage-réseaux',  type: ChannelType.GuildText,  topic: 'Partage tes contenus et réseaux sociaux' },
          ],
        },
        {
          category: '🛠️ SR EDITER — APP',
          channels: [
            { name: '❓・faq-et-guide',    type: ChannelType.GuildText,   topic: 'Foire aux questions & guides de démarrage' },
            { name: '📥・téléchargements', type: ChannelType.GuildText,   topic: 'Liens de téléchargement officiels SR Editer' },
            { name: '💡・suggestions',     type: ChannelType.GuildForum,  topic: 'Propose des idées d\'amélioration' },
            { name: '🐛・signalement-bugs', type: ChannelType.GuildForum, topic: 'Signale un bug dans SR Editer' },
          ],
        },
        {
          category: '🎫 SUPPORT',
          channels: [
            { name: '🎫・ouvrir-un-ticket', type: ChannelType.GuildText,   topic: 'Ouvre un ticket d\'assistance individuelle' },
        ...
        },
        {
          ...
          channels: [
            ...
            { name: '🎬・vocal-création', type: ChannelType.GuildVoice },
        ...
        },
        {
          ...
          channels: [
            ...
            { name: '👥・staff-général', type: ChannelType.GuildText, private: true },
            { name: '🔊・vocal-staff',   type: ChannelType.GuildVoice, private: true },
          ],
        },
        {
          category: '🎟️ TICKETS',
